...
export type GetInspectorsQuery = { __typename?: 'Query', getInspectors?: Array<{ __typename?: 'Inspector', id: number, name: string }> };
...
export type GetInspectionPlanningQuery = { __typename?: 'Query', getInspectionPlanning?: { __typename?: 'InspectionResult', PlanningData: Array<{ __typename?: 'InspectionPlanningData', ShouldBeVisited: boolean, NrOfDaysSinceLastVisit?: number, OrganizerTargetActual: number, SpecialtyTargetActual: number, SessieData: { __typename?: 'PlanningData', SessieID: number, BeginDatum: any, Begintijd?: string, BeginDatumTijd?: any, InstellingID: number, CursusID: number, VakID: number, InstellingNaam: string, Woonplaats?: string, Titel?: string, VisitatieID?: number, CursusStatus?: string, VisitatieStatus?: string, DatumVisitatie?: any, PersoonID?: number, VakType: string } }>, InspectionStatisticsOverall?: { __typename?: 'VisitingData', NrOfCourses: number, NrOfVisits: number, AverageRate?: number, AverageScoreAccordingIntention?: number, VisitTarget: number, VisitTargetActual: number }, StatisticsPerOrganizer?: Array<{ __typename?: 'StatisticsPerOrganizer', OrganizerId: number, OrganizerName: string, OrganizerType: string, VisitingData?: { __typename?: 'VisitingData', NrOfCourses: number, NrOfVisits: number, VisitTargetActual: number, VisitTarget: number, AverageRate?: number, AverageScoreAccordingIntention?: number, LastVisitData?: { __typename?: 'LastVisitData', VisitedDate?: any, InspectorId?: number, ReportGrade?: number, ReportCreatedDate?: any, AccordingIntention?: boolean } }, SpecialtyStatistics?: Array<{ __typename?: 'StatisticsPerSpecialty', VakID: number, Title: string, VakType: string, VisitingData?: { __typename?: 'VisitingData', NrOfCourses: number, NrOfVisits: number, VisitTargetActual: number } }> }> } };
...
export type UpdatePlanningMutation = { __typename?: 'Mutation', updatePlanning: { __typename?: 'UpdatePlanningResult', planned: boolean } };
...
export type GetSessieDetailsQuery = { __typename?: 'Query', Sessie?: { __typename?: 'Sessie', SessieID: number, CursusID: number, SessieType: string, DatumBegintijd: any, DatumEindtijd: any, Cursus?: { __typename?: 'Cursus', Titel?: string, VakID?: number, CursusCode?: string, Promotietekst?: string, Vak: { __typename?: 'Vak', IsExamenVak?: boolean, Themas?: Array<{ __typename?: 'Thema', Naam: string }>, Competenties?: Array<{ __typename?: 'Competentie', Naam: string }>, Vakgroep?: { __typename?: 'Vakgroep', Naam: string, Contactgegevens: { __typename?: 'Contactgegevens', DisplayAddress?: string, TerAttentieVan?: string, Telefoon?: string, Email?: string } }, ExamenInstelling?: { __typename?: 'ExamenInstelling', Naam: string, Contactgegevens: { __typename?: 'Contactgegevens', DisplayAddress?: string, TerAttentieVan?: string, Telefoon?: string, Email?: string } }, Beoordelingen?: Array<{ __typename?: 'Beoordeling', Beoordelaar?: { __typename?: 'Persoon', FullName?: string } }> } }, Lokatie?: { __typename?: 'Lokatie', Naam: string, Contactgegevens: { __typename?: 'Contactgegevens', DisplayAddress?: string } } } };
...
export function useGetInspectorsQuery(baseOptions?: Apollo.QueryHookOptions<GetInspectorsQuery, GetInspectorsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetInspectorsQuery, GetInspectorsQueryVariables>(GetInspectorsDocument, options);
      }
export function useGetInspectorsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetInspectorsQuery, GetInspectorsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetInspectorsQuery, GetInspectorsQueryVariables>(GetInspectorsDocument, options);
        }
...
export function useGetInspectionPlanningQuery(baseOptions: Apollo.QueryHookOptions<GetInspectionPlanningQuery, GetInspectionPlanningQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetInspectionPlanningQuery, GetInspectionPlanningQueryVariables>(GetInspectionPlanningDocument, options);
      }
export function useGetInspectionPlanningLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetInspectionPlanningQuery, GetInspectionPlanningQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetInspectionPlanningQuery, GetInspectionPlanningQueryVariables>(GetInspectionPlanningDocument, options);
        }
...
export function useUpdatePlanningMutation(baseOptions?: Apollo.MutationHookOptions<UpdatePlanningMutation, UpdatePlanningMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdatePlanningMutation, UpdatePlanningMutationVariables>(UpdatePlanningDocument, options);
      }
...
export function useGetSpecialtyQuery(baseOptions: Apollo.QueryHookOptions<GetSpecialtyQuery, GetSpecialtyQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetSpecialtyQuery, GetSpecialtyQueryVariables>(GetSpecialtyDocument, options);
      }
export function useGetSpecialtyLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSpecialtyQuery, GetSpecialtyQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetSpecialtyQuery, GetSpecialtyQueryVariables>(GetSpecialtyDocument, options);
        }
...
export function useGetSessieDetailsQuery(baseOptions: Apollo.QueryHookOptions<GetSessieDetailsQuery, GetSessieDetailsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetSessieDetailsQuery, GetSessieDetailsQueryVariables>(GetSessieDetailsDocument, options);
      }
export function useGetSessieDetailsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetSessieDetailsQuery, GetSessieDetailsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetSessieDetailsQuery, GetSessieDetailsQueryVariables>(GetSessieDetailsDocument, options);
        }
